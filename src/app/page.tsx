    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden pt-16">
        ...
        <div className="pointer-events-none absolute inset-0 -z-10">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,oklch(0.556_0_0/0.08)_1px,transparent_0)] [background-size:24px_24px]" />
        </div>
        ...
        <div className="mx-auto max-w-6xl px-6 pb-24 pt-24 sm:pb-32 sm:pt-32">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100 font-display text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
              Respond to RFPs{' '}
            ...
            <p className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
              Upload your RFP documents and let AI generate accurate, contextual responses. Review,
              refine, and finalize — all in one platform.
            </p>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              From document analysis to final submission, streamline your entire RFP workflow.
            </p>
          </div>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              },
              {
                ...
                description: 'Built-in workflow for team review, approval, and version tracking.',
              },
              {
                icon: Zap,
                title: 'Learn & Improve',
                description: 'The system learns from approved responses to get smarter over time.',
              },
            ].map((feature) => (
              <div
                key={feature.title}
      ...
      <section className="py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Go from raw RFP document to polished response in minutes, not days.
            </p>
          </div>
          ...
          <div className="grid gap-12 sm:grid-cols-3">
            {[
              ...
              <div key={item.step} className="relative text-center">
                <div className="mb-4 text-5xl font-black text-brand/20">{item.step}</div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                Stop copying and pasting from old proposals. Let AI handle the heavy lifting while
            ...
            <div className="rounded-2xl border border-border/60 bg-card p-8 shadow-sm">
              <div className="space-y-4">
                ...
                <div className="mt-6 rounded-lg bg-muted p-4">
                  ...
                  <div className="mt-1 text-right text-xs text-muted-foreground">78% complete</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-[oklch(0.15_0_0)] px-8 py-16 text-center sm:px-16">
            ...
            <div className="relative">
              ...
              <p className="mx-auto mt-4 max-w-xl text-lg text-white/60">
                Join teams that are winning more bids in less time. Get started in minutes.
              </p>
